...
select
    ...
    tm_id,
    tm_name,
    sum(if(ds>=date_add('2025-06-25',-6),order_count_1d,0)),
    sum(if(ds>=date_add('2025-06-25',-6),order_num_1d,0)),
    sum(if(ds>=date_add('2025-06-25',-6),order_original_amount_1d,0)),
    sum(if(ds>=date_add('2025-06-25',-6),activity_reduce_amount_1d,0)),
    sum(if(ds>=date_add('2025-06-25',-6),coupon_reduce_amount_1d,0)),
    sum(if(ds>=date_add('2025-06-25',-6),order_total_amount_1d,0)),
    sum(order_count_1d),
    sum(order_num_1d),
...
where ds>=date_add('2025-06-25',-29)
