...
-- todo 1. 小区维度表
-- todo base_complex
-- todo base_region_info
-- todo express_courier_complex
...
-- todo 4. dim_express_courier_full
...
from (select id,
      ...
      from ods_express_courier_full
        where is_deleted = '0') express_cor_info
         join (
    select id,
           org_name
    from ods_base_organ_full
...
insert overwrite table tms.dim_user_zip
...
select after.id,
       ...
       '9999-12-31'                             end_date
from ods_user_address_full after
where dt = '20250719'
  and after.is_deleted = '0';
